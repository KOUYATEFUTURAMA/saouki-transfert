						...
						<div class="col-lg-12 d-flex align-items-center">
							...
							<div class="login-form login-signin">
								...
								<form class="form w-xxl-550px rounded-lg p-20" method="post" action="{{ route('login') }}" novalidate="novalidate" id="kt_login_signin_form" style="background-color: #fff;">
									...
									<div class="form-group">
										...
										<input class="form-control form-control-solid h-auto p-4 rounded-lg" type="text" value="{{ old('email') }}" name="email" required autocomplete="email" autofocus/>
										@error('email')
											<h4 style="color: red;">{{ "Le login n'est pas correcte" }}</h4>
										@enderror
									</div>
                                    ...
                                    <div class="input-icon input-icon-right">
                                        <input type="password" name="password" id="password-field" autocomplete="off" autocomplete="current-password" class="form-control form-control-solid h-auto p-4 rounded-lg" placeholder="Mot de passe" required>
                                        <span>
							...
							<div class="login-form login-forgot">
                                <div class="overlay overlay-block">
                                    <!--begin::Form-->
                                    <form action="" class="form w-xxl-550px rounded-lg p-20" novalidate="novalidate" id="kt_login_forgot_form"  style="background-color: #fff;">
                                                @csrf
                                        ...
                                        <!--begin::Form group-->
                                        <div class="form-group">
                                            <input class="form-control form-control-solid h-auto p-4 rounded-lg font-size-h6" type="email" placeholder="E-mail" name="email" required/>
                                        </div>
