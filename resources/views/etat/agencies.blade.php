            ...
            <div class="card-body">
                <div class="bg-white rounded shadow-sm py-5 px-10 px-lg-20">
                    ...
                    <table id="table" class="table table-bordered table-hover table-checkable dataTable no-footer dtr-inline"
                            ...
                            data-search="false"
                            data-toggle="table"
                            data-url="{{ url('parametre', ['action' => 'list-solde-agencies']) }}"
                            data-unique-id="id"
                            ...
                            <thead>
                                <tr role="row">
                                    ...
                                    <th data-field="totalEntree">Entr&eacute;e</th>
                                    <th data-field="totalSortie">Sortie</th>
...
<script type="text/javascript">
   ...
   function ficheAgency(idAgency){
        alert('In progrsse !' + idAgency);
   }

   function ficheFormatter(id, row) {
       return '<a class="flaticon2-list text-primary cursor-pointer mr-4 ml-2" data-toggle="tooltip" title="Fiche du client" onClick="javascript:ficheAgency(' + row.id + ');"></a>';
   }
</script>
@endsection
