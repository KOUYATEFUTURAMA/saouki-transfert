            ...
            <div class="card-body">
                <div class="bg-white rounded shadow-sm py-5 px-10 px-lg-20">
                    <div class="row">
                        <div class="col-xl-4">
                            <div class="form-group">
                                <label for="theme_id">Recherche par nom du partenaire</label>
                                <div class="input-group input-group-sm">
                                    <input type="text" class="form-control" placeholder="Mohamed" id="searchByName">
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4">
                    ...
                    <table id="table" class="table table-bordered table-hover table-checkable dataTable no-footer dtr-inline"
                            ...
                            data-search="false"
                            data-toggle="table"
                            data-url="{{ url('parametre', ['action' => 'list-solde-partenairs']) }}"
                            data-unique-id="id"
                            data-show-columns="false"
                            data-show-toggle="false">
                            <thead>
                                <tr role="row">
                                    <th data-field="name">Partenaire</th>
                                    <th data-field="contact">Contact</th>
                                    <th data-field="country.libelle_country">Pays</th>
                                    <th data-field="totalEntree">D&eacute;p&ocirc;t</th>
                                    <th data-field="totalSortie">Retrait</th>
...
<script type="text/javascript">
   ...
   function fichePartenair(idPartenair){
        alert('In progrsse !' + idPartenair);
   }

   function ficheFormatter(id, row) {
       return '<a class="flaticon2-list text-primary cursor-pointer mr-4 ml-2" data-toggle="tooltip" title="Fiche du client" onClick="javascript:fichePartenair(' + row.id + ');"></a>';
   }
</script>
@endsection
